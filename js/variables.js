...
var nombre = "Jimmy"; //sintaxis para poder hacer una variable, el espacio en al memoria se define como nombre.
// al momento de llamar a la variable == Jimmy
//dos estados de una varible
//declarar la varible es var edad;
var edad;
edad
//inicializardarle dar un valor a la variable var edad: 30;
edad = 30;
edad
//Para asignar un valor a las variables utilizar el signo de igual =
//Variables complejas 
//variable de arrays que es un conjunto de elementos
var elementos = ["Computadora", "Celular"];
console.log (elementos [1]); //ver elementos del array
